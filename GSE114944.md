...
### Sample information
Peripheral blood, uninvolved LNs, metastatic LNs, and tumor samples were obtained from 15 individuals with head and neck small cell carcinoma(HNSCC), melanoma, colon cancer, rectal cancer, lung cancer, colorectal liver metastasis(CRLM), and ovarian cancer.
