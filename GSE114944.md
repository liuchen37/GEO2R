...
write.table(DP.exp, file = "DP.csv")

# process DN raw data
# load .cel file
file.choose()
setwd("/Users/chenliu/Documents/GEO/GSE114944/GSE114944_RAW/DN")
DN <- ReadAffy()
sampleNames(DN)
...
write.table(DN.exp, file = "DN.csv")

# process CD103SP raw data
# load .cel file
file.choose()
setwd("/Users/chenliu/Documents/GEO/GSE114944/GSE114944_RAW/CD103SP")
SP <- ReadAffy()
sampleNames(SP)
...
write.table(SP.exp, file = "CD103SP.csv")
